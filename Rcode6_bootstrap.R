...
# But in reality we will not be able to do this simulation.


# This is a situation where the bootstrap should work.
# Note in this case if the errors are not gaussian, Bootstrap will still work,
# because in the linear regression central limit theorem kicks in and Bootstrap
# consistency will still be fulfilled.
